...
1. <strong>v.</strong> 评价；评估
   - <div class="example-sentence">Teachers <mark>evaluate</mark> students' performance regularly.
   <span class="chinese-translation">老师定期评估学生的表现。</span></div>
   - <div class="example-sentence">We need to <mark>evaluate</mark> the risks first.
